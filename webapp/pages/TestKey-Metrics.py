...
c1.write("<u>Medcines used in terms <b>GFR - Low Risk</b></u> ("+str(len(MedsByGfr))+")",unsafe_allow_html=True)
c1.dataframe(MedsByGfr,width=400,height=450,hide_index=True)
c3.write("<u>Medcines used in terms <b>Stages - Low Risk</b></u> ("+str(len(MedsByStages))+")",unsafe_allow_html=True)
c3.dataframe(MedsByStages,width=400,height=450,hide_index=True)
c1.write("<u>Medcines used in terms <b>GFR - High Risk</b></u> ("+str(len(MedsNotByGfr))+")",unsafe_allow_html=True)
c1.dataframe(MedsNotByGfr,width=400,height=450,hide_index=True)
c3.write("<u>Medcines used in terms <b>Stages - High Risk</b></u> ("+str(len(MedsNotByStages))+")",unsafe_allow_html=True)
